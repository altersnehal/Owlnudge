    ...
    <header className="w-full max-w-2xl mx-auto sticky top-3 sm:top-4 z-40 mb-6 sm:mb-8 px-3 sm:px-4">
      ...
      <div className="bg-white/90 backdrop-blur-2xl rounded-full px-4 py-2 flex items-center justify-between gap-3 border border-white/80 shadow-[0_10px_30px_-5px_rgba(15,61,35,0.05),0_1px_3px_0_rgba(0,0,0,0.02)]">
        ...
        <div className="flex items-center gap-2.5 shrink-0 select-none">
          <div className="w-7 h-7 rounded-full bg-emerald-50 flex items-center justify-center p-0.5 shrink-0">
        ...
        {/* Right Corner Controls (Parallel in single bar like standard theme/action buttons) */}
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            title={isAudioOn ? "Sound & Tik-Tik (On)" : "Sound (Muted)"}
          >
            {isAudioOn ? (
          ...
          <button
            ...
            className="px-3.5 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs font-semibold flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm active:scale-95 transition duration-150 shrink-0"
